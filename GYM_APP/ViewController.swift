...
class ViewController: UIViewController, CLLocationManagerDelegate, GMSMapViewDelegate, GMSAutocompleteViewControllerDelegate, UITextFieldDelegate {
    ...
    let previewDemoData = [(title: "Fitness 24", img: #imageLiteral(resourceName: "Image3"), price: 10), (title: "Bay Club", img: #imageLiteral(resourceName: "Image1"), price: 8), (title: "Sports Club", img: #imageLiteral(resourceName: "Image2"), price: 12)]
    ...
    func initGoogleMaps() {
        let camera = GMSCameraPosition.camera(withLatitude: 37.3382, longitude: 121.8863, zoom: 17.0)
    ...
    func mapView(_ mapView: GMSMapView, markerInfoContents marker: GMSMarker) -> UIView? {
        ...
        gymPreviewView.setData(title: data.title, img: data.img, price: data.price)
        return gymPreviewView
    }
    ...
    func setupViews() {
        ...
        setupTextField(textField: txtFieldSearch, img: #imageLiteral(resourceName: "google-map-marker"))
        
        gymPreviewView=GymPreviewView(frame: CGRect(x: 0, y: 0, width: self.view.frame.width, height: 190))
    ...
    var gymPreviewView: GymPreviewView = {
        let v=GymPreviewView()
        return v
    }()
}
